...
const Blog = () => {
    return (
        <>
            <Helmet>
                <title>Blog - {profileData.personal.name}</title>
                <meta name="description" content="Thoughts on Web Development, SEO strategies, and the future of digital technology." />
            </Helmet>
