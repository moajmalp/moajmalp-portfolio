...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About - {profileData.personal.name} | {profileData.personal.title}</title>
        <meta name="description" content={`Learn more about ${profileData.personal.name}, ${profileData.personal.title} based in ${profileData.personal.location}. ${profileData.biography.substring(0, 150)}...`} />
        <link rel="canonical" href={`${profileData.seo.baseUrl}/about`} />
        <meta property="og:title" content={`About - ${profileData.personal.name}`} />
        <meta property="og:description" content={profileData.biography.substring(0, 200)} />
        <meta property="og:url" content={`${profileData.seo.baseUrl}/about`} />
