    ...
    projects: [
        {
            ...
            description: "A comprehensive educational and training platform specializing in alternative and traditional medicine, featuring online course enrollment, student portals, and scheduling systems.",
            image: "/assets/kugoriental.png",
            tags: ["WordPress", "PHP", "LMS", "SEO Strategy", "Custom Theme"],
        ...
        {
            id: 2,
            title: "G7 Corporate Platform",
            description: "A premium corporate web application showcasing diverse business divisions, featuring sleek glassmorphism designs, scroll-driven interactive cards, and high-fidelity assets.",
            image: "/assets/g7_website.png",
            tags: ["React", "Next.js", "Tailwind CSS", "Framer Motion", "Vercel"],
            liveUrl: "https://g7-website-phi.vercel.app/",
            codeUrl: "",
            featured: true
        },
        {
            id: 3,
            title: "Klashra Travel & Tourism",
            description: "An elegant travel booking portal for a luxury Dubai-based agency, offering bespoke holiday packages, custom flight/hotel search views, and lead generation systems.",
            image: "/assets/klashra.png",
            tags: ["WordPress", "Custom CSS", "Lead Funnel", "SEO Optimization"],
            liveUrl: "http://klashra.com/",
            codeUrl: "",
            featured: true
        },
        {
            id: 4,
            title: "V SAF Arabia",
            description: "A dynamic portfolio showcase for a premier GCC advertising, design, and production agency, highlighting immersive event setups, 3D indoor fabrications, and retail activations.",
            image: "/assets/vsafad.png",
            tags: ["WordPress", "GSAP Animations", "Media Showcase", "Premium UX"],
            liveUrl: "https://www.vsafad.com/",
            codeUrl: "",
            featured: true
        },
        {
            id: 5,
            title: "PageNow Digital Solutions",
            description: "A state-of-the-art interactive website for a full-service digital agency, featuring custom AI automated workflows, SEO audit integration, and rich animations.",
            image: "/assets/pagenow.png",
            tags: ["WordPress", "AI Automation", "SEO Audit Engine", "Performance Tuning"],
            liveUrl: "https://www.pagenow.in/",
            codeUrl: "",
            featured: true
        }
    ],
